...
function telaCadastroAtividade() {
    ...
    return (
        ...
        <div className="w-full h-screen lg:bg-[var(--light-blue)] lg:flex lg:flex-col lg:items-center lg:justify-center">
            ...
            <div className="w-full h-screen px-8 flex flex-col lg:w-[50%] lg:h-[40%] lg:bg-white">
