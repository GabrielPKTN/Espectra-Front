...
function GeraComportamento({ array, corNumeracao }) {
        ...
        arrayComponents.push(
            ...
            <div className="py-5">
                ...
                <CardQuestionFormulario
                    idPortage={comportamento.id_atividade_portage}
                ...
                <div className="w-full mt-6">
                    <GroupResposta idPortage={comportamento.id_atividade_portage} opcoes={["Sim", "Não", "Sim, com mediação"]} />
                </div>
