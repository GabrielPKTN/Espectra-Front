...
function GeraComportamento({ array, corNumeracao, setRespostas }) {
        ...
        arrayComponents.push(
            ...
            <div className="py-5" key={comportamento.id_atividade_portage} data-key={comportamento.id_atividade_portage}>
                ...
                <div className="w-full mt-6">
                    <GroupResposta setRespostas={setRespostas} idFormPortage={`${comportamento.id_habilidade}-${comportamento.id_atividade_portage}`} opcoes={["Sim", "Não", "Sim, com mediação"]} />
                </div>
